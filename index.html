    ...
    <div class="container">
      ...
      <nav>
        <div class="nav-left">
          ...
          <a href="login.php" data-en="Login" data-cs="Přihlásit">Login</a>
        </div>

        <div class="nav-right language-toggle">
          <button onclick="switchLanguage('en', 'index.html')">English</button>    
          <button onclick="switchLanguage('cs', 'index.html')">Čeština</button>  
        </div>
      </nav>
